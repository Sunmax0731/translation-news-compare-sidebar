...
translation-news-compare-sidebar の作業手順です。
...
- asset は `dist/translation-news-compare-sidebar-docs.zip`、`docs/manual-test.md`、`docs/strict-manual-test-addendum.md`。
